...
Opciones:
  --help: ayuda
  --licence: muestra la licencia del programa

  --debug: modo depuración (detalla y confirma las operaciones) "controlador.py --prueba --debug".
...
if __name__ == '__main__':
    ...
    if "--register" in sys.argv or "--unregister" in sys.argv:
        ...
        if '--help' in sys.argv:
            print AYUDA.encode('utf8')
            sys.exit(0)

        if '--licence' in sys.argv:
            print LICENCIA.encode('utf8')
            sys.exit(0)
